...
if __name__ == '__main__':
    ...
    zeroWeights = create_zero_dimension_weight()

    oneDimWeights = create_one_dimension_weight(input_x_size)

    thirdWeight = create_two_dimension_weight(input_x_size,  # 创建二次项的权重变量
                                              field_size,
